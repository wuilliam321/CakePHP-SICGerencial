...
<div class="container">
    ...
    <div class="title"><h1><?php echo __('Edit Categoria de Comunicacion'); ?></h1></div>
    <div class="two_third">
    	<div class="pagenation">&nbsp;<?php echo $this->Html->link(__('Home'), '/'); ?> <i>/</i> <?php echo $this->Html->link(__('Categorias de Comunicacion list'), array('action' => 'index')); ?> <i>/</i> <?php echo __('Edit'); ?></div>
    </div>

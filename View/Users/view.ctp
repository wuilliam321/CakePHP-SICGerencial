...
<div class="related">
	...
	<?php foreach ($user['Directorio'] as $directorio): ?>
		<tr>
			<td><?php echo $directorio['id']; ?></td>
			<td><?php echo $directorio['codigo']; ?></td>
			<td><?php echo $directorio['fecha_inicio']; ?></td>
			<td><?php echo $directorio['fecha_fin']; ?></td>
			<td><?php echo $directorio['objetivo']; ?></td>
			<td><?php echo $directorio['detalles']; ?></td>
			<td><?php echo $directorio['es_nueva']; ?></td>
			<td><?php echo $directorio['created']; ?></td>
			<td><?php echo $directorio['modified']; ?></td>
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'directorios', 'action' => 'delete', $directorio['id']), array(), __('Are you sure you want to delete # %s?', $directorio['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	...
	<?php foreach ($user['Asignacione'] as $asignacione): ?>
		<tr>
			<td><?php echo $asignacione['id']; ?></td>
			<td><?php echo $asignacione['codigo']; ?></td>
			<td><?php echo $asignacione['asignador_id']; ?></td>
			<td><?php echo $asignacione['responsable_id']; ?></td>
			<td><?php echo $asignacione['dependencia_id']; ?></td>
			<td><?php echo $asignacione['titulo']; ?></td>
			<td><?php echo $asignacione['detalles']; ?></td>
			<td><?php echo $asignacione['porcentaje_asignado']; ?></td>
			<td><?php echo $asignacione['porcentaje_distribuido']; ?></td>
			<td><?php echo $asignacione['progreso']; ?></td>
			<td><?php echo $asignacione['fecha_asignacion']; ?></td>
			<td><?php echo $asignacione['fecha_entrega']; ?></td>
			<td><?php echo $asignacione['fecha_recepcion']; ?></td>
			<td><?php echo $asignacione['parent_id']; ?></td>
			<td><?php echo $asignacione['completada']; ?></td>
			<td><?php echo $asignacione['lft']; ?></td>
			<td><?php echo $asignacione['rght']; ?></td>
			<td><?php echo $asignacione['es_nueva']; ?></td>
			<td><?php echo $asignacione['created']; ?></td>
			<td><?php echo $asignacione['modified']; ?></td>
			<td class="actions">
...
<div class="related">
	...
	<?php if (!empty($user['Comunicacione'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Codigo'); ?></th>

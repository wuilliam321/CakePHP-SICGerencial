		...
		<div class="row">
			<div class="col-xs-4 left-sidebar">
				...
				<div class="form-group">
					...
					<div class="col-xs-8">
						<?php echo $this->Form->input('porcentaje_asignado', array('max' => 100, 'min' => 0, 'value' => 100, 'div' => array('class' => 'input-group'), 'after' => '<div class="input-group-addon">%</div>', 'escape' => false)); ?>
					</div>
				</div>

...
<?php echo $this->Form->create('Asignacione'); ?>
	<fieldset>
		<legend><?php echo __('Edit Asignacione'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Asignacione.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Asignacione.id'))); ?></li>
